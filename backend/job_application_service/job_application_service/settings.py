"""
Django settings for job_application_service project.
...
ROOT_URLCONF = 'job_application_service.urls'
...
WSGI_APPLICATION = 'job_application_service.wsgi.application'
...
DATABASES = DATABASES = {
    'default': {
        ...
        'NAME': 'applications_db',  # database name
