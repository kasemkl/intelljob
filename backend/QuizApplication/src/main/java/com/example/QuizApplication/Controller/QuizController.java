...
public class QuizController {
    ...
    @GetMapping("/job-post/{quizId}/applicant")
    public ResponseEntity<Quiz> getQuizByJobPost(@PathVariable long quizId) {
        Quiz quiz = quizService.getQuizWithoutAnswersByJobPost(quizId);
